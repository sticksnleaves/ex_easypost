defmodule ExEasyPost.BatchTest do
  ...
  describe "add_shipments/2" do
    test "builds an operation" do
      ...
      assert %ExEasyPost.Operation{http_method: :post, params: ^params, path: "batches/foo/add_shipments"}
  ...
  describe "create/1" do
    test "builds an operation" do
      ...
      assert %ExEasyPost.Operation{http_method: :post, params: ^params, path: "batches"}
  ...
  describe "remove_shipments/2" do
    test "builds an operation" do
      ...
      assert %ExEasyPost.Operation{http_method: :post, params: ^params, path: "batches/foo/remove_shipments"}
