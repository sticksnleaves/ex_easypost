defmodule ExEasyPost.CarrierAccountTest do
  ...
  describe "create/1" do
    test "builds an operation" do
      ...
      assert %ExEasyPost.Operation{ http_method: :post, params: %{ carrier_account: ^params }, path: "carrier_accounts" }
  ...
  describe "update/2" do
    test "builds an operation" do
      ...
      assert %ExEasyPost.Operation{ http_method: :put, params: %{ carrier_account: ^params }, path: "carrier_accounts/foo" }
